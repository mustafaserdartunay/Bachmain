...
import {
  ...
  BachySettingsPage,
  AiEnterpriseOrgPage,
  AiAutonomousCompanyPage,
  AiAppBuilderPage,
  KnowledgeCenterPage,
  DigitalTwinCenterPage,
  ManufacturingCenterPage,
  MesOperatorTabletPage,
  FinanceCenterPage,
  AnalyticsCenterPage,
  CustomerExperienceCloudPage,
  CustomerDetailPage,
  CustomerLoadShipmentCreatePage,
  CustomerMovementDetailPage,
  ...
  ExpenseListPage,
  LoanPaymentsPage,
  IncomingEInvoicesPage,
  IncomingEInvoiceDetailPage,
  EDocumentsHubPage,
  EDocumentListPage,
  EDocumentDetailPage,
  EDocumentComposePage,
  EDocumentSettingsPage,
  EDocumentSearchPage,
  ExpensesReportPage,
  PaymentsReportPage,
  VatReportPage,
  ...
  PriceListsPage,
  StockHistoryPage,
  StockProductsReportPage,
  CostCalculatorRoute,
  DeliveredPage,
  SettingsPage,
  TeamUsersPage,
  LabelsSettingsPage,
  TagLabelsSettingsPage,
  CashBankSettingsPage,
  ProfilePage,
  VersionPage,
  PackagesPage,
  AnnouncementsPage,
  ...
  SectoralSettingsPage,
  SectoralCategorySettingsPage,
  GuncelDurumSettingsPage,
  TaxVatSettingsPage,
  DocumentCenterPage,
  DocTemplatesPage,
  DocTemplateDesignerPage,
  DocLabelDesignerPage,
  DocPrintPage,
  DocPrintJobsPage,
  DocPrintProfilesPage,
  WebStudioPaymentPage,
  WebStudioSettingsPage,
  WebStudioCategoryCreatePage,
  WebStudioProductCreatePage,
  WebStudioTemplatePage,
  WebStudioOrdersPage,
  WebStudioDomainConnectPage,
  WebStudioPage,
  WebStudioBuilderPage,
