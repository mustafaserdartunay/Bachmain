...
export default function BankAccountsSettingsEditor({
  accounts,
  onUpdateAccount,
  onAddAccount,
  onRemoveAccount,
  ...
  return (
    <div>
      {accounts.length > 0 ? (
        <div ref={listRef} className="max-h-[28rem] space-y-1.5 overflow-y-auto pr-0.5">
            ...
            return (
              <div key={account.id}>
                {pendingDeleteId === account.id ? (
                  ...
                  <div className="group rounded-xl border border-dark-500/50 bg-dark-700/70 transition-colors hover:bg-dark-700/80">
                    <div className="flex w-full items-center">
                      ...
                      <button
                        ...
                        className="min-w-0 flex-1 truncate px-1 py-2 text-left text-xs font-bold text-gray-300"
                      >
                        {displaySummary(account)}
                      </button>
                      <button
