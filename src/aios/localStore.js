...
export const AIOS_AGENTS_SEED = [
  ...
  { id: 'ai.ops_director', name: 'AI Operasyon Direktörü', role: 'operations', enabled: true },
  { id: 'ai.sales_manager', name: 'AI Satış Müdürü', role: 'sales', enabled: true },
  { id: 'ai.crm_specialist', name: 'AI CRM Uzmanı', role: 'crm', enabled: true },
  { id: 'ai.production_planner', name: 'AI Üretim Planlama', role: 'production', enabled: true },
  { id: 'ai.quality', name: 'AI Kalite Uzmanı', role: 'quality', enabled: true },
  { id: 'ai.warehouse', name: 'AI Depo Uzmanı', role: 'warehouse', enabled: true },
  { id: 'ai.logistics', name: 'AI Lojistik Planlama', role: 'logistics', enabled: true },
  { id: 'ai.procurement', name: 'AI Satın Alma', role: 'procurement', enabled: true },
  { id: 'ai.accounting', name: 'AI Muhasebe', role: 'finance', enabled: true },
  ...
  { id: 'ai.support', name: 'AI Destek', role: 'support', enabled: true },
  { id: 'ai.data_analyst', name: 'AI Veri Analisti', role: 'analytics', enabled: true },
