...
export const APP_SURFACE_PANEL_CLASS =
  'app-surface-panel relative rounded-[24px] border border-white/40'
...
export const APP_PANEL_TITLE_CLASS = 'truncate text-xs font-extrabold tracking-wide text-gray-300'
...
/** Güncel Durum / header aksiyonları ile aynı etiket boyutu */
export const APP_UI_TEXT_CLASS = 'text-xs font-extrabold tracking-wide text-gray-300'
export const APP_LABEL_CLASS = `truncate ${APP_UI_TEXT_CLASS}`
export const APP_SUBLABEL_CLASS =
  'truncate text-xs font-extrabold leading-none tracking-wide text-gray-300'
export const APP_VALUE_CLASS = 'text-[20px] font-black tabular-nums leading-tight'
export const APP_ICON_SM_CLASS = 'h-4 w-4 shrink-0'
...
export const APP_PAGE_TITLE_CLASS =
  'truncate text-[20px] font-black uppercase tracking-wide text-gray-300'
export const APP_FILTER_LABEL_CLASS = `shrink-0 ${APP_UI_TEXT_CLASS}`
