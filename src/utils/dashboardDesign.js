...
export const APP_LABEL_CLASS = 'truncate text-xs font-extrabold tracking-wide text-gray-300'
export const APP_SUBLABEL_CLASS =
  'truncate text-[11px] font-extrabold leading-none tracking-wide text-gray-300'
...
export const APP_PAGE_TITLE_CLASS =
  'truncate text-2xl font-black uppercase tracking-wide text-blue-300'
export const APP_FILTER_LABEL_CLASS = 'mb-2 text-xs font-extrabold tracking-wide text-gray-300'
