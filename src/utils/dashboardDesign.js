...
export const APP_PANEL_TITLE_CLASS = 'truncate text-xs font-extrabold leading-none text-[var(--ink)]'
...
export const APP_LABEL_CLASS = 'app-titlecase-words truncate text-[12px] font-semibold leading-tight text-[var(--muted)]'
export const APP_SUBLABEL_CLASS = 'app-titlecase-words truncate text-[11px] font-bold leading-none text-[var(--muted)]'
...
export const APP_PAGE_TITLE_CLASS = 'text-xl font-extrabold uppercase tracking-wide text-[var(--ink)]'
export const APP_FILTER_LABEL_CLASS = 'mb-2 text-[12px] font-black capitalize tracking-wider text-[var(--muted)]'
...
export const APP_OMNI_EMPTY_CLASS = 'px-4 py-8 text-center text-xs font-semibold text-[var(--muted)]'
