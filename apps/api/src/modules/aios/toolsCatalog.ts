...
export const AIOS_TOOLS: AiosTool[] = [
  ...
  {
    id: 'live.delayed',
    label: 'Live Delayed Deliveries',
    description: 'Şu anda geciken teslimat ve varlıkları listele (okuma).',
    modules: ['logistics', 'live'],
  ...
  {
    id: 'live.offline',
    label: 'Live Offline Vehicles',
    description: 'Çevrimdışı araç ve sürücüleri listele (okuma).',
    modules: ['logistics', 'live'],
    permission: 'live.view',
    requiresHumanApproval: false,
    inputSchema: {},
  ...
  {
    id: 'live.region',
    label: 'Live Region Personnel',
    description: 'Bölgedeki aktif personeli göster (okuma).',
    modules: ['logistics', 'live'],
    permission: 'live.view',
    requiresHumanApproval: false,
  ...
  {
    id: 'live.route.change',
    label: 'Change Live Route',
    description: 'Canlı rota değişikliği. Kullanıcı onayı gerekir.',
    modules: ['logistics', 'live'],
    permission: 'live.route',
    requiresHumanApproval: true,
    inputSchema: { entityId: 'string', routeId: 'string' },
  },
  {
    id: 'data.bulk_import',
