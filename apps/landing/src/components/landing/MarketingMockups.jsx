      ...
      <div className="mock-browser">
        ...
        <div className="mock-db-inner">
          <div className="mock-sidebar">
            <img src="/assets/bachmain-logo.png" alt="BACHMAIN" className="brand-logo-img" draggable={false} />
              ...
              <div className="mock-card">
                ...
                <div className="mock-bars">
                  {[38, 54, 46, 68, 58, 79, 94].map((h, i) => (
                    <div key={i} className={`mock-bar ${i === 6 ? "hi" : ""}`} style={{ height: `${h}%` }} />
                  ))}
                </div>
              </div>
              <div className="mock-card">
          ...
          <div className="mock-fdb-sidebar">
            ...
            {[
              ...
              <div key={label} className={`mock-fsi ${on ? "on" : ""}`}>
                <span className="mock-fsi-ico">{ico}</span>{label}
              </div>
            ))}
            ...
            <div className="mock-chart-row">
              <div className="mock-chart-box">
                ...
                <svg className="mock-chart-svg" viewBox="0 0 500 220" preserveAspectRatio="none">
                  ...
                  <path d="M0,180 C80,160 160,130 240,95 C320,60 400,40 500,18 L500,220 L0,220 Z" fill="url(#cg)" />
                  <path d="M0,180 C80,160 160,130 240,95 C320,60 400,40 500,18" fill="none" stroke="#3B82F6" strokeWidth="2.5" />
  ...
  return (
    <div className="mock-map">
      ...
      <svg className="mock-map-route" viewBox="0 0 400 480">
        <path d="M80,390 Q160,290 200,210 Q240,140 290,110 Q330,90 350,130" fill="none" stroke="#3B82F6" strokeWidth="2.5" strokeDasharray="8,5" opacity=".5" />
      </svg>
      {pins.map((p, i) => (
        <motion.div
          key={i}
      ...
      <div className="mock-map-panel">
        <div className="mock-mp-stat"><div className="mock-mp-val">12</div><div className="mock-mp-lab">Temsilci Aktif</div></div>
        <div className="mock-mp-div" />
        <div className="mock-mp-stat"><div className="mock-mp-val">84</div><div className="mock-mp-lab">Ziyaret Bugün</div></div>
        <div className="mock-mp-div" />
        <div className="mock-mp-stat"><div className="mock-mp-val">₺1.2M</div><div className="mock-mp-lab">Günlük Satış</div></div>
      </div>
    </div>
  );
}
    ...
    <div className="mock-phone">
      <div className="mock-pscreen">
        ...
        <div className="mock-ph-header">
          ...
          <div className="mock-ph-name">Instagram DM <span>· bach.main</span></div>
        </div>
        <div className="mock-ph-msgs">
          <div className="mock-pm l">
            <div className="mock-pm-av">👤</div>
            <div className="mock-pm-bub">Merhaba, ürünleriniz hakkında bilgi alabilir miyim? <span className="mock-pm-src ig">IG</span></div>
          </div>
          <div className="mock-pm r">
            <div className="mock-pm-bub">Merhaba! BACHMAIN platformunu tanıtmaktan memnuniyet duyarım. Hangi modül ilginizi çekiyor?</div>
          ...
          <div className="mock-pm r">
            <div className="mock-pm-bub">Size özel demo ayarlayabiliriz! Ücretsiz 30 dk demo için tarih belirleyelim mi? 🚀</div>
            <div className="mock-pm-av navy">B</div>
          </div>
        </div>
      </div>
