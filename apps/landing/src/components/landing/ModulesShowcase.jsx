    ...
    case "tiktok":
      return (
        <svg {...common} viewBox="0 0 24 24">
          <path fill="#25F4EE" d="M16.5 2h-3.1v13.1a2.7 2.7 0 1 1-1.9-2.6V9.3a5.9 5.9 0 1 0 5 5.8V8.4A7.4 7.4 0 0 0 21 9.7V6.5A7.3 7.3 0 0 1 16.5 2z" opacity=".9" />
          ...
          <path fill="#111" d="M14.6 3.9h-1.2v12.3a2 2 0 1 1-1.4-1.9v-1.4a5.2 5.2 0 1 0 4.3 5.1v-5.9a8.1 8.1 0 0 0 4.7 1.5V11a8 8 0 0 1-5.1-2.9V3.9z" />
        </svg>
      );
    case "mail":
      return (
        <svg {...common} viewBox="0 0 24 24">
          <path fill="#EA4335" d="M2 6.5A2.5 2.5 0 0 1 4.5 4h15A2.5 2.5 0 0 1 22 6.5v11a2.5 2.5 0 0 1-2.5 2.5h-15A2.5 2.5 0 0 1 2 17.5v-11z" />
        ...
        <ScrollReveal className="mb-8">
          <div className={`mod-theme-card ${night ? "night" : ""}`}>
            <div className="mod-theme-copy">
              ...
              <p>
                Panel görünümünü tek tıkla değiştirin. Gündüzde net okuma, gecede göz yormayan koyu arayüz —
                tüm ekranlar aynı deneyimde.
              </p>
            </div>
          ...
          <div className={`mod-foot ${night ? "night" : ""}`}>
            <div>
              ...
              <p className="mt-2 max-w-xl text-sm opacity-65">
                Fotoğraflı aşamalar, B2B sipariş, kampanya, cari, canlı mesaj —
                tüm kanallar tek platformda.
              </p>
            </div>
