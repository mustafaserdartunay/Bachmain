...
export const moduleShowcase = [
  {
    icon: 'Users',
    title: 'Müşteriler',
    desc: 'Kartlar, fırsatlar ve ilişki geçmişi.',
    tone: 'blue',
    href: '/features/crm',
    tag: 'CRM',
  },
  {
    icon: 'Factory',
    title: 'Tedarikçiler',
    desc: 'Tedarik zinciri ve performans.',
    tone: 'slate',
    href: '/features/erp',
    tag: 'ERP',
  },
  {
    icon: 'Package',
    title: 'Ürün & Hizmet',
    desc: 'Katalog, varyant ve fiyat listeleri.',
    tone: 'violet',
    href: '/features/stock',
    tag: 'Katalog',
  },
  {
    icon: 'Boxes',
    title: 'Stok',
    desc: 'Anlık stok, barkod ve rezervasyon.',
    tone: 'amber',
    href: '/features/stock',
    tag: 'Stok',
  },
  {
    icon: 'Warehouse',
    title: 'Depo',
    desc: 'Çoklu depo, raf ve transfer.',
    tone: 'orange',
    href: '/features/stock',
    tag: 'Depo',
  },
  {
    icon: 'Wallet',
    title: 'Kasa',
    desc: 'Nakit akış ve kasa hareketleri.',
    tone: 'emerald',
  ...
  },
  {
    icon: 'Store',
    title: 'POS & Kasa',
    desc: 'Mağaza satışı, fiş ve canlı kasa.',
    tone: 'rose',
    href: '/features/finance',
    tag: 'POS',
  },
  {
    icon: 'FileText',
    title: 'e-Fatura',
    desc: 'GİB uyumlu e-fatura / e-arşiv.',
    tone: 'indigo',
    href: '/e-invoice',
    tag: 'e-Belge',
  },
  {
    icon: 'Landmark',
    title: 'Banka · Çek · Senet',
    desc: 'Banka, çek ve senet takibi.',
    tone: 'teal',
    href: '/features/finance',
    tag: 'Finans',
  },
  {
    icon: 'MapPin',
    title: 'Saha Satış',
    desc: 'GPS, rota, ziyaret ve sipariş.',
    tone: 'orange',
    href: '/modules/field-sales',
    tag: 'Saha',
  },
  {
    icon: 'Radar',
    title: 'Temsilci İzleme',
    desc: 'Saha ekibi, puantaj ve prim.',
    tone: 'sky',
    href: '/modules/field-sales',
    tag: 'Prim',
  },
  ...
  },
  {
    icon: 'Truck',
    title: 'Nakliye & Palet',
    desc: 'Tır, koli, paket, palet hesabı.',
    tone: 'blue',
    href: '/features/stock',
    tag: 'Lojistik',
  },
  {
    icon: 'ClipboardList',
    title: 'Teklif',
    desc: 'Hızlı teklif, onay ve revizyon.',
    tone: 'violet',
    href: '/features/erp',
    tag: 'Satış',
  },
  {
    icon: 'ShoppingCart',
    title: 'Sipariş',
    desc: 'Siparişten sevkiyata tek akış.',
    tone: 'sky',
    href: '/features/erp',
    tag: 'Satış',
  },
  {
    icon: 'Cog',
    title: 'Üretim',
    desc: 'İş emri, MRP ve kalite kontrol.',
    tone: 'slate',
    href: '/modules/production',
    tag: 'MRP',
  },
  {
    icon: 'Contact',
    title: 'CRM',
    desc: 'Pipeline, lead ve müşteri yolculuğu.',
    tone: 'blue',
    href: '/features/crm',
    tag: 'CRM',
  },
  {
    icon: 'ListTodo',
    title: 'Görevler',
    desc: 'Görev oluştur, ata, takip et.',
    tone: 'emerald',
    href: '/features/crm',
    tag: 'İş',
  },
  {
    icon: 'CalendarDays',
    title: 'Randevu',
    desc: 'Takvim, hatırlatma ve ziyaret.',
    tone: 'cyan',
    href: '/features/crm',
    tag: 'Takvim',
  },
  {
    icon: 'NotebookPen',
    title: 'Not Defteri',
    desc: 'Kayıt notları ve hatırlatmalar.',
    tone: 'amber',
    href: '/features/crm',
    tag: 'Not',
  },
  {
    icon: 'Activity',
    title: 'Canlı Ödeme',
    desc: 'Aktivite ve tahsilat ekranı.',
    tone: 'green',
    href: '/features/finance',
    tag: 'Canlı',
  },
  {
    icon: 'MoonStar',
    title: 'Gündüz / Gece',
    desc: 'Tek tıkla tema değiştirme.',
    tone: 'fuchsia',
    href: '/features',
    tag: 'Tema',
  },
  {
    icon: 'UserCog',
    title: 'Personel',
    desc: 'İşe giriş-çıkış ve vardiya.',
    tone: 'purple',
    href: '/features/erp',
    tag: 'İK',
  },
  ...
  },
  {
    ...
    desc: 'KPI, dashboard ve derin analiz.',
    tone: 'teal',
  ...
  },
  {
    icon: 'Ticket',
    title: 'Ticket & Destek',
    desc: 'B2B destek talepleri ve SLA.',
    tone: 'rose',
    href: '/help',
    tag: 'Destek',
  },
  {
    icon: 'Megaphone',
    title: 'Kampanyalar',
    desc: 'B2B kampanya ve fırsat takibi.',
    tone: 'orange',
    href: '/features/erp',
    tag: 'B2B',
  },
  {
    icon: 'Receipt',
    title: 'Cari Takip',
    desc: 'Borç-alacak ve cari ekstre.',
    tone: 'emerald',
    href: '/features/finance',
    tag: 'Cari',
  },
