...
export const supportDropdown = [
  ...
  { label: 'Yardım Merkezi', href: '/help-center' },
  { label: 'SSS', href: '/sss' },
...
export const blogPosts = [
  {
    slug: 'erp-gecis-rehberi',
    title: 'ERP Geçiş Rehberi: 7 Adımda Başarı',
    excerpt: "KOBİ'ler için ERP geçişinde dikkat edilmesi gerekenler.",
    date: '12 Haz 2026',
    category: 'Rehber',
  },
  {
    slug: 'b2b-portal-onemi',
    title: 'B2B Portal Neden Kritik?',
    excerpt: 'Müşterilerinizin self-servis beklentisi ve BACH çözümü.',
    date: '8 Haz 2026',
    category: 'B2B',
  },
  {
    ...
    excerpt: 'Depo verimliliğini artıran pratik öneriler.',
    date: '1 Haz 2026',
    category: 'Stok',
  },
  {
    ...
    excerpt: 'GİB düzenlemeleri ve uyum takvimi.',
    date: '28 May 2026',
    category: 'E-Belge',
  },
  {
    slug: 'saha-satis-dijital',
    title: 'Saha Satışta Dijital Dönüşüm',
    excerpt: 'Mobil CRM ile saha ekibi verimliliği.',
    date: '20 May 2026',
    category: 'Satış',
  },
  {
    ...
    excerpt: 'Müşteriye anlık üretim görünürlüğü.',
    date: '15 May 2026',
    category: 'Üretim',
  },
]
