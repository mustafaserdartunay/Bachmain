  ...
  return (
    <html lang="tr" className={poppins.variable}>
      <head>
        ...
        <link rel="icon" href="/favicon-512.png?v=6" type="image/png" sizes="512x512" />
        <link rel="icon" href="/favicon-192.png?v=6" type="image/png" sizes="192x192" />
        <link rel="icon" href="/favicon-48.png?v=6" type="image/png" sizes="48x48" />
