...
const moduleDefinitions: Omit<ModuleConfig, 'metrics'>[] = [
  ...
  { id: 'memberships', title: 'Üye Hesapları', subtitle: 'bachmain.com / uygulama kayıtlı kullanıcılar', singularName: 'Üye', path: '/uyeler',
    columns: [
      ...
      { key: 'tenantCode', label: 'Tenant' },
      { key: 'createdAt', label: 'Kayıt', sortable: true },
      { key: 'lastLoginAt', label: 'Son Giriş', sortable: true },
    ],
    formFields: [
